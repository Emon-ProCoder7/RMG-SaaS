        ...
        <Table>
          <TableHeader>
            <TableRow className="bg-black/20">
              ...
              <TableHead className="font-semibold text-amber-200 hidden md:table-cell">Order Date</TableHead>
              <TableHead className="font-semibold text-amber-200 hidden md:table-cell">Expected</TableHead>
          ...
          <TableBody>
            {orders.length === 0 ? (
              ...
              <TableRow key={po.id} className="hover:bg-amber-500/5 transition-colors">
                ...
                <TableCell className="text-sm hidden md:table-cell">{new Date(po.order_date).toLocaleDateString()}</TableCell>
                <TableCell className="text-sm hidden md:table-cell">{po.expected_date ? new Date(po.expected_date).toLocaleDateString() : "—"}</TableCell>
