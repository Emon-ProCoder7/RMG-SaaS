...
export default function PrintInvoicePage() {
  ...
  return (
    <div ref={printRef} className="max-w-4xl mx-auto p-8 print:p-4" style={{ fontFamily: "'Courier New', monospace" }}>
      <style>{`
        @page { margin: 10mm; }
      ...
      <div className="no-print text-center mb-4">
        <button onClick={() => window.print()} className="px-4 py-2 bg-indigo-600 text-white rounded-lg">Print Invoice</button>
      </div>
